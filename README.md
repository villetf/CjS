...
CjS (Custom JavaScript) är ett verktyg som används för att med hjälp av skräddarsydda anpassningar effektivisera sitt dagliga arbete i Övervakningssystem, Ärendehanteringssystem, SIEM-system, Virusskyddssystem och Sårbarhetsskanningssystem.

CjS består främst av sex Javascriptfiler: monsys.js, servicedesk.js, siem.js, virusprot.js, vulnscan.js och basskript.js. De alla utgör dock projektet CjS och har därför ett gemensamt versionsnummer.
...
Du får nu upp en ruta där du fyller i det reguljära uttrycket `/*.domain.se*/`. Genom att göra detta anger du att basskriptet ska köras om man är på en sida på domain.se. Välj därefter Add.
...
Du får nu upp en ruta där du ska ta bort all text (inklusive tomma rader) och lägga in länken https://serverx.domain.se/cjs/basskript.js.
...
Inne på checksidan i Övervakningssystem finns ett antal knappar, varav de största autoförminskar sig om man förminskar webbläsarfönstret.

!["Bild av Övervakningssystem med de stora knapparna till vänster"](./resources/readme_screenshot_5.png "Bild av Övervakningssystem med de stora knapparna till vänster")
...
* #### Skapa ärende
   ...
   Skapa ärende samlar in den information som behövs för ett ärende, och öppnar därefter ett nytt ärende med Larmhantering-mallen i en ny flik. Inne i ärendet så fylls beställare i som Teamet automatiskt, därefter associeras aktuell host som tillgång (förutsatt att den hittas). Om en tillgång kunde associeras så görs ett API-anrop mot CMDB som kollar vilket system som körs på hosten och associerar även detta. Om ett system har hittats kollas även via API-anrop vilket team som supportar systemet, varpå system och team skrivs ut med röd text ovanför Grupplistan. Slutligen så fylls ärendeinformationen i automatiskt i ärendetexten. Det enda som användaren behöver göra är alltså att tilldela ärendet till en grupp, ge en titel och kontrollera att alla uppgifter stämmer. I Övervakningssystem-fliken öppnas ackningssidan, så att man med hjälp av [Kopiera ärendelänk-knappen](#kopiera-ärendelänk) snabbt kan klistra in en länk till ärendet som kommentar till ackningen.

* #### Autogenerera ärende

   Autogenerera ärende-knappen samlar in nödvändig information från Övervakningssystem och skapar därefter ett ärende via servicedesk-API:et. För att det ska funka förutsätter det att det i CMDB finns ett systen som körs på hosten och en supportgrupp till systemet. Om detta inte finns får man en varning, och inget ärende skapas. Innan ärendet skapas frågas man om prioritet på ärendet. I Övervakningssystem läggs också en ackning med länk till ärendet följt av vem som lagt ärendet.

* #### Visa i Visualiseringssystem

   Visa i Visualiseringssystem-knappen öppnar aktuell host i Visualiseringssystem. Dashboarden som öppnas är en översiktsdashboard som visar åtkomststatus, packet loss, CPU-användning, minnesanvändning och diskanvändning. Är vald enhet en nätverksenhet så öppnas en dashboard för nätverksutrustning som visar åtkomststatus, packet loss över tid, trafikmängd in och ut samt errors in och ut.

* #### Visa i Nätverkshanteringssystem

   Visa i Nätverkshanteringssystem-knappen söker på hosten i Nätverkshanteringssystem.
...
På övriga ställen i Övervakningssystem finns nedanstående funktioner:
...
* #### Kopiera larminfo
   ...
   !["Bild av Övervakningssystem med Kopiera larminfo-knappen markerad"](./resources/readme_screenshot_6.png "Bild av Övervakningssystem med Kopiera larminfo-knappen markerad")
...
* #### Sök CI från listvyn
   ...
   !["Bild av Övervakningssystem med Sök CI-knappen markerad"](./resources/readme_screenshot_7.png "Bild av Övervakningssystem med Sök CI-knappen markerad")
...
* #### Skapa ärende från listvyn
   ...
   !["Bild av Övervakningssystem med Skapa ärende-knappen markerad"](./resources/readme_screenshot_8.png "Bild av Övervakningssystem med Skapa ärende-knappen markerad")
...
* #### Checka alla
   ...
   !["Bild av Övervakningssystem med Checka alla-knappen markerad"](./resources/readme_screenshot_9.png "Bild av Övervakningssystem med Checka alla-knappen markerad")
...
I ärendehanteringssystemet finns två funktioner som effektiviserar arbetet.

* #### Kopiera ärendelänk

   Kopiera ärendelänk-knappen finns på ärenden, längst till höger på listen med knappar högst upp i ärendet.

   !["Bild av servicedesk med Kopiera ärendelänk-knappen markerad"](./resources/readme_screenshot_10.png "Bild av servicedesk med Kopiera ärendelänk-knappen markerad")
...
* #### Visa i Övervakningssystem

   Visa i Övervakningssystem-knappen finns inne på sidan för ett CI i CMDB. Knappen finns på listen längst upp på sidan.

   !["Bild av servicedesk med Visa i Övervakningssystem-knappen markerad"](./resources/readme_screenshot_11.png "Bild av servicedesk med Visa i Övervakningssystem-knappen markerad")

   Knappen tar en till Övervakningssystem-sidan för aktuellt CI.

<br>

### SIEM

För närvarande finns det tre funktioner i SIEM, vilket är två knappar som finns uppe till höger när man är inne på ett offense.

!["Bild av SIEM med de två knapparna markerade"](./resources/readme_screenshot_12.png "Bild av SIEM med de två knapparna markerade")
...
* #### Skapa ärende med länk
   ...
   Skapa ärende med länk-knappen öppnar ett nytt ärende i servicedesk med Larmhantering som mall. Den kopierar också offenselänken på samma sätt som Kopiera offenselänk-knappen, så att man direkt kan klistra in en länk i ärendet. Den öppnar även offensets sida för att lägga till en anteckning i en ny flik, så att man kan lägga till en anteckning med till exempel ärendelänk.

*  #### Sök CI

   När man är inne i SIEM söks det automatiskt efter sådant som ser ut som hostnamn enligt orgnisationens namnstandard. Om några hostnamn hittas läggs det till en Sök CI-knapp efter dem, som söker på hosten i servicedesk.

*  ### Autogenerera ärende

   Autogenerera ärende-knappen samlar in information om offenset och skapar därefter ett servicedesk-ärende och går till det. Det skapas dessutom automatiskt en kommentar i SIEM med länk till ärendet.

<br>

### Virusskyddssystem

I Virusskyddssystem finns det två knappar på varje dator som ligger i Inboxen.

!["Bild av Virusskyddssystem med de två knapparna markerade"](./resources/readme_screenshot_13.png "Bild av Virusskyddssystem med de två knapparna markerade")

* #### Sök CI

   Sök CI-knappen söker på den aktuella hosten i servicedesk.
...
* #### Pinga host
   ...
   Pinga host-knappen använder sig av SIEM-serverns pingfunktion. Detta innebär att man kan komma att få upp en inloggningsruta för SIEM när man använder knappen. Det innebär också att det inte är möjligt att använda knappen på icke-trådat nät.

<br>

### Sårbarhetsskanningssystem

I Sårbarhetsskanningssystem finns det två knappar, Sök i CMDB och Sök i Nätverkshanteringssystem.

* #### Sök CI
   
   Sök CI-knappen söker på den aktuella hosten i servicedesk. Knappen sätts in överallt där det finns ett hostnamn.

* #### Sök i Nätverkshanteringssystem

   Sök i Nätverkshanteringssystem-knappen söker på den aktuella IP-adressen i Nätverkshanteringssystem. Knappen sätts in överallt där det finns en IP-adress.

<br>

## Loggning

När du använder funktioner i CjS så loggas detta automatiskt till Log4CjS, ett API på servern serverX. Loggarna läggs därefter i en databas, där man kan se statistik över hur funktionerna används. Datan som samlas in är tid, vilken funktion som använts, eventuellt objekt som hanterats (t.ex. ett CI), vilken hemsida man befinner sig på, och vem som använt funktionen. Mer info om Log4CjS finns [här.](https://codeplatform.domain.se/team/log4cjs)

## Support

För buggrapporter och förbättringsförslag, [öppna ett issue i Kodplattformen.](https://codeplatform.domain.se/team/cjs/-/issues "Issue") Märk issuet med någon av labelarna "Bugg" eller "Förbättringsförslag".