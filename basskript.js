...
// Skripten förvaras på servern serverX. I pluginet anges regexet /*.ltkalmar.se*/, vilket gör
// att på alla sidor på den domänen kollar den i basskriptet ifall det finns något skript för den
// aktuella sidan. Länken till skriptet är https://serverx.ltkalmar.se/cjs/basskript.js.
//
// Mer info finns på https://gitlab.ltkalmar.se/oc/cjs.



const serverLink = 'https://serverx.ltkalmar.se/cjs';
...
if (window.location.href.startsWith('https://op5.ltkalmar.se/') || window.location.href.startsWith('https://op5test.ltkalmar.se/')) {
...
if (window.location.href.startsWith('https://siem.ltkalmar.se/')) {
   script.src = `${serverLink}/qradar.js`;
}

if (window.location.href.startsWith('https://ampconsole.ltkalmar.se/')) {
